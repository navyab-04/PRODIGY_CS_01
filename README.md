...
Open the project folder containing `caesar_cipher.py`.
...
Enter the message and the shift value when prompted.
...
Enter your choice: 1
Enter the message: Navya
Enter shift value: 3

Encrypted Message: Qdybd

Enter your choice: 2
Enter the message: Qdybd
Enter shift value:3

Decrypted Message: Navya
...
* Understanding the Caesar Cipher encryption technique
